            ...
            [ 
                dbc.Col(html.Div(
                            [  # Se crea una fila.
                                ...
                                dbc.Row(
                                    [
                                        dbc.Col(id="salida_grafica_cir", style={'text-align': 'center'}) # Se crea una columna con el titulo.
                                    ],
                                ), 
                            ...
                            [  # Se crea una fila.
                                ...
                                dbc.Row(
                                    [
                                        dbc.Col(html.Div(
                                            dbc.Row(
                                                dbc.Col(table_cir, width={'size': 10, 'offset': 0}),justify='center',align='center')
                            ),
